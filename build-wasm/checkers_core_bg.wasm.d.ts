...
export function game_get_best_move(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
...
export function game_finish_check(a: number, b: number): number;
